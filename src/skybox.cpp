...
void Skybox::initTexture() {
  ...
  texImages.push_back("../image/px.png");
  texImages.push_back("../image/nx.png");
  texImages.push_back("../image/ny.png");
  texImages.push_back("../image/py.png");
  texImages.push_back("../image/pz.png");
  texImages.push_back("../image/nz.png");
